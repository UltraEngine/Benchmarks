...
void main(void)
{
	...
	vec4 outcolor = ex_color * brightness;
	float alpha;
	...
	cubecoord = normalize(worldpos.xyz);
	...
	fragData0 = (1.0 - fogeffect) * outcolor * materialcolordiffuse * brightness + fogeffect * vec4(fogcolor.xyz,1.0f);
	fragData0.a = 0.75;
}
